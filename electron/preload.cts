...
const bridge: ImnotaBridge = {
  ...
  openCapturePermissionSettings: () => ipcRenderer.invoke('workflow:capture:open-permission-settings'),
  ...
  getBackupHistory: () => ipcRenderer.invoke('backups:list'),
  chooseBackupLocation: () => ipcRenderer.invoke('backups:choose-location'),
  createBackupSnapshot: (input) => ipcRenderer.invoke('backups:create', input),
  inspectBackupSnapshot: (input) => ipcRenderer.invoke('backups:inspect', input),
  ...
  searchProjects: (input) => ipcRenderer.invoke('projects:search', input),
  searchContent: (input) => ipcRenderer.invoke('projects:search-content', input),
  ...
  createContentItem: (input) => ipcRenderer.invoke('content:create', input),
  loadContentItem: (input) => ipcRenderer.invoke('content:load', input),
  saveContentItem: (input) => ipcRenderer.invoke('content:save', input),
  ...
  setProjectArchived: (input) => ipcRenderer.invoke('projects:set-archived', input),
  ...
  prepareOnboardingHandoff: (input) => ipcRenderer.invoke('onboarding:prepare-handoff', input),
  copyOnboardingHandoff: (input) => ipcRenderer.invoke('onboarding:copy-handoff', input),
  openOnboardingHandoff: (input) => ipcRenderer.invoke('onboarding:open-handoff', input),
