...
This change implements the desktop and hosted-service portions of [the design plan](../history/ui-overhaul-plan-20260908.md), starting from `main` at `3475c2d`. The original working checkout and its unrelated changes were left untouched.
