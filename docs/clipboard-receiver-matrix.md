...
Status: protocol and record for proving paste into real editors. Automated tests confirm that Imnota wrote clipboard formats. They do not prove that a receiving application accepted Markdown, the image, or both.
...
| ------------------------------------- | ------- | ----------------- | -------------- | ----------------- | ------------- | ---------- | ------------- | ---- | --------------- | ----- |
| Cursor                                | Windows | pending           | pending        | pending           | pending       | pending    | pending       |      |                 |       |
| VS Code (chat or Markdown editor)     | Windows | pending           | pending        | pending           | pending       | pending    | pending       |      |                 |       |
| Browser assistant (Claude or ChatGPT) | Windows | pending           | pending        | pending           | pending       | pending    | pending       |      |                 |       |
| Native Markdown editor                | Windows | pending           | pending        | pending           | pending       | pending    | pending       |      |                 |       |
| Cursor                                | macOS   | pending           | pending        | pending           | pending       | pending    | pending       |      |                 |       |
