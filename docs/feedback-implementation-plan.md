...
Local verification: formatting, lint, both TypeScript configurations, 20 tests, production build, Windows NSIS/portable packaging and packaged Electron smoke checks pass. The synthetic 100-image check imports 1920 × 1080 images in about three seconds and reopens the warmed project in about 30–35 ms on this machine; this is not a cross-platform performance guarantee. Mac/Linux packaging and a new public release have not been performed for these changes. Vite reports a non-failing renderer bundle-size warning.
