...
| Local history (workspace `.imnota-backups`, not in this branch until next-features land) | Project snapshots and restore                   | Restore as new project or in place with a safety copy    |
