...
export const SHORTCUT_ACTIONS = [
  ...
  { id: 'navigation.back', group: 'Navigation', label: 'Go back' },
  { id: 'navigation.forward', group: 'Navigation', label: 'Go forward' },
  ...
  { id: 'capture.region', group: 'Screenshots', label: 'Capture screen region (experimental)' },
  { id: 'capture.repeatLastRegion', group: 'Screenshots', label: 'Repeat last captured region' },
...
const DEFAULT_COMMON: ResolvedShortcutBindings = {
  ...
  'navigation.forward': 'Alt+ArrowRight',
  ...
  'capture.repeatLastRegion': 'Ctrl+Shift+6',
